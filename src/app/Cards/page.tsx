  ...
  return (
    <div className="flex flex-wrap gap-4 overflow-hidden justify-center items-center h-[765px]">
      <div className="relative">
        <img src='https://images.pexels.com/photos/5905887/pexels-photo-5905887.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500' className="w-[1490px] h-[705px] rounded-xl" />
        <div className="absolute top-0 p-16 text-white">
          <div className="text-3xl font-bold">Full Stack Development</div>
          <div className="w-[521px] text-base font-semibold mt-2">
          ...
          <div className="flex gap-2 items-center justify-center w-[1300px] mt-8 cursor-pointer">
          ...
          <div className="flex w-[1340px] justify-between">
